...
// let myinfo3 = "내 이름은", myName, "이고요, 사는 곳은", mycity, "이예요";
...
console.log(myName + num1); // 숫자와 문자열의 덧샘 = 숫자가 문자열 취급되어 연결됨
...
console.log(letters[3][0] + [1][3] + [0][1] + [0][3] + [2][2]);
...
let nu1 = 123;
let nu2 = "123";
console.log(typeof nu1 + " isn't " + typeof nu2 + " date type");
console.log(
...
let mathScore = prompt("수학의 점수를 입력하세요");
let engScore = prompt("영어의 점수를 입력하세요");
